    ...
    vec![
        ...
        ProcessDetails::new(
            ...
            vec![
                ...
                (AddressType::YPosition, vec![0x01_0F_B8_C8, 0x14]),
                (AddressType::ZPosition, vec![0x01_0F_B8_C8, 0x18]),
                (AddressType::CameraSin, vec![0x01_10_1E_30, 0x58, 0x20]),
                (AddressType::CameraCos, vec![0x01_10_1E_30, 0x58, 0x24]),
            ]
            .iter()
            .cloned()
            .collect(),
        ...
        ProcessDetails::new(
            ...
            vec![
                ...
                (
                    AddressType::CutsceneLength,
                    vec![0x01_49_51_C0, 0x48, 0x10, 0x08],
                ),
                (
                    AddressType::CutsceneId,
        ...
        ProcessDetails::new(
            ...
            vec![
                ...
                (AddressType::CameraSin, vec![0x03_6A_7A_00, 0x70]),
                (AddressType::CameraCos, vec![0x03_6A_7A_00, 0x74]),
        ...
        ProcessDetails::new(
            ...
            vec![
                ...
                (AddressType::CameraSin, vec![0x03_6A_BA_00, 0x70]),
                (AddressType::CameraCos, vec![0x03_6A_BA_00, 0x74]),
        ...
        ProcessDetails::new(
            ...
            vec![
                ...
                (AddressType::YPosition, vec![0x01_45_1F_78, 0x14]),
                (AddressType::ZPosition, vec![0x01_45_1F_78, 0x18]),
                (AddressType::CutscenePrompt, vec![0x01_49_7A_C0, 0x10]),
